...
| CoreDNS Latency | The proportion of sufficiently fast DNS resolution, as measured from CoreDNS pods's metrics.<br>“Sufficiently fast” is any resolution taking less than 0.016 seconds. Only A records resolutions are considered.             | 99% success  |
| Local Node DNS Cache Latency | The proportion of sufficiently fast DNS resolution, as measured from NodeLocalDNSCache pods's metrics.<br>“Sufficiently fast” is any resolution taking less than 0.008 seconds.  Only A records resolutions are considered.  | 99% success  |
