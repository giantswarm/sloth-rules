...
| CoreDNS Latency | The proportion of sufficiently fast DNS resolution for `local` zones, as measured from CoreDNS pods's metrics.<br>“Sufficiently fast” is any resolution taking less than 0.016 seconds.           | 99% success  |
