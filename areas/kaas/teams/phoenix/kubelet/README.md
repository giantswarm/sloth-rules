...
| Runtime Duration        | The proportion of sufficiently fast requests, as measured from Kubelet.<br>“Sufficiently fast” is different based on the resource type and the operation involved, as follows:<br><ul><li>Duration of mutating Kubelet runtime calls by operation type "create/update", measured as 99th percentile over a period window: 10s</li>   | 99% success  |
